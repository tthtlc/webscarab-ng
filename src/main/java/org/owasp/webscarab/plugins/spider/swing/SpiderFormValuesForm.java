 ...
 * 
 */
public class SpiderFormValuesForm extends AbstractTableMasterForm {

	private static final String FORM_ID = "spiderFormValuesForm";
	private static final String DETAIL_FORM_ID = "spiderFormValuesForm";

	public SpiderFormValuesForm(HierarchicalFormModel model) {
