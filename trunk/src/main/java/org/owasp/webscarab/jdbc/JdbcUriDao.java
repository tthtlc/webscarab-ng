...
public class JdbcUriDao extends PropertiesJdbcDaoSupport implements
    ...
    private SelectAllQuery selectAllQuery;
    ...
    protected void initDao() throws Exception {
        ...
        selectAllQuery = new SelectAllQuery();
    ...
    private class SelectAllQuery extends MappingSqlQuery {

        public SelectAllQuery() {
            super(getDataSource(), "SELECT id, uri FROM uris");
            compile();
        }
        public Collection<URI> getAll() {
